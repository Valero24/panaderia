...
import type { ExtraForm, ExtraService } from "../package-form-model";
import { money } from "../package-form-model";

type PackagePremiumServicesStepProps = {
...
export default function PackagePremiumServicesStep({
  editingId,
  canManage,
  extras,
  extraForm,
  ...
  saveExtra,
  toggleExtra,
}: PackagePremiumServicesStepProps) {
  return (
